package com.stylefeng.guns.alipay.modular.service.impl;

import com.alibaba.dubbo.config.annotation.Reference;
import com.alibaba.dubbo.config.annotation.Service;
import com.alipay.api.response.AlipayTradePrecreateResponse;
import com.stylefeng.guns.alipay.modular.alipay.config.Configs;
import com.stylefeng.guns.alipay.modular.alipay.model.ExtendParams;
import com.stylefeng.guns.alipay.modular.alipay.model.GoodsDetail;
...
import com.stylefeng.guns.alipay.modular.alipay.service.AlipayMonitorService;
...
public class AliPayServiceAPIImpl implements AliPayServiceAPI {
    ...
    public AliPayResultVO getOrderStatus(String orderId) {
        ...
        if (isSuccess) {
            ...
            aliPayResultVO.setOrderMsg("订单支付失败，请稍后重试");
            return aliPayResultVO;
        }
    }
    ...
    public String trade_precreate(String orderId) {
        ...
        String body = "购买电影票一共花费：" + orderInfoVO.getOrderPrice();

        // 商户操作员编号，添加此参数可以为商户操作员做销售统计
        String operatorId = "lanzhao";

        // (必填) 商户门店编号，通过门店号和商家后台可以配置精准到门店的折扣信息，详询支付宝技术支持
        String storeId = "武汉王道训练营";
